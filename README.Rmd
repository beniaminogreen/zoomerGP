...
datasets (N > 10,000). At the moment, only the gaussian likelihood is
supported, but functionality to fit other likelihoods with Variational
Inference is in development.
